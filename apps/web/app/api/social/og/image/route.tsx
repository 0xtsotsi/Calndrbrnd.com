...
import { Meeting, App, Generic, getOGImageVersion } from "@calndrbrnd/lib/OgImages";
    ...
    switch (imageType) {
      ...
      case "app": {
        try {
          ...
          const svgHashesModule = await import("@calndrbrnd/web/public/app-store/svg-hashes.json");
