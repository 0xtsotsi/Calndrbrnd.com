...
import { getOGImageVersion } from "@calndrbrnd/lib/OgImages";
...
vi.mock("@calndrbrnd/lib/OgImages", async (importOriginal) => {
  return await importOriginal();
});

vi.mock(import("@calndrbrnd/lib/constants"), async (importOriginal) => {
  return await importOriginal();
});

vi.mock("@calndrbrnd/web/public/app-store/svg-hashes.json", () => ({
  default: {
