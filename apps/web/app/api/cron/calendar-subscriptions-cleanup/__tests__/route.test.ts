...
vi.mock("@calndrbrnd/features/calendar-subscription/lib/cache/CalendarCacheEventService");
vi.mock("@calndrbrnd/features/calendar-subscription/lib/cache/CalendarCacheEventRepository");
...
vi.mock("@calndrbrnd/lib/server/perfObserver", () => ({
  performance: {
    mark: vi.fn(),
    measure: vi.fn(),
  },
...
vi.mock("@calndrbrnd/lib/server/getServerErrorFromUnknown", () => ({
