 ...
 */
vi.mock("@calndrbrnd/features/shell/Shell", () => ({
  ShellMain: vi.fn(),
}));

vi.mock("@calndrbrnd/lib/hooks/useApp", () => ({
  default: vi.fn(),
}));
/**
...
vi.mock(
  "@calndrbrnd/app-store/routing-forms/components/react-awesome-query-builder/widgets",
