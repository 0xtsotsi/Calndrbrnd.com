...
import { AppDependencyComponent } from "@calndrbrnd/app-store/AppDependencyComponent";
import { InstallAppButton } from "@calndrbrnd/app-store/InstallAppButton";
import { isRedirectApp } from "@calndrbrnd/app-store/_utils/redirectApps";
import useAddAppMutation from "@calndrbrnd/app-store/_utils/useAddAppMutation";
import { doesAppSupportTeamInstall, isConferencing } from "@calndrbrnd/app-store/utils";
import DisconnectIntegration from "@calndrbrnd/features/apps/components/DisconnectIntegration";
import { AppOnboardingSteps } from "@calndrbrnd/lib/apps/appOnboardingSteps";
import { getAppOnboardingUrl } from "@calndrbrnd/lib/apps/getAppOnboardingUrl";
import { APP_NAME, COMPANY_NAME, SUPPORT_MAIL_ADDRESS, WEBAPP_URL } from "@calndrbrnd/lib/constants";
import { useCompatSearchParams } from "@calndrbrnd/lib/hooks/useCompatSearchParams";
import { useLocale } from "@calndrbrnd/lib/hooks/useLocale";
import { trpc } from "@calndrbrnd/trpc/react";
import type { App as AppType } from "@calndrbrnd/types/App";
import classNames from "@calndrbrnd/ui/classNames";
import { Badge } from "@calndrbrnd/ui/components/badge";
import { Button } from "@calndrbrnd/ui/components/button";
import { Icon } from "@calndrbrnd/ui/components/icon";
import { SkeletonButton, SkeletonText } from "@calndrbrnd/ui/components/skeleton";
