...
import type { GlobalCal, GlobalCalWithoutNs, Queue } from "@calndrbrnd/embed-core";
// FIXME: embed-snippet is a published package and shouldn't import from @calndrbrnd/types which is unpublished
...
import type { Optional } from "@calndrbrnd/types/utils";
