 ...
 *
 * NOTE: This is a duplicate of the function in @calndrbrnd/lib/hooks/useRouterQuery.ts. It has to be here because embed is published to npm and shouldn't refer to any private package
 */
