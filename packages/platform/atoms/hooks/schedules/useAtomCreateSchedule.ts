...
import type { CreateScheduleHandlerReturn } from "@calndrbrnd/trpc/server/routers/viewer/availability/schedule/create.handler";
import { TCreateInputSchema as CreateScheduleSchema } from "@calndrbrnd/trpc/server/routers/viewer/availability/schedule/create.schema";
