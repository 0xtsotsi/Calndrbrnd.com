...
export default defineConfig({
    ...
    rollupOptions: {
      ...
      output: {
        globals: {
          ...
          "@calndrbrnd/prisma/client": "@calndrbrnd/prisma/client",
        },
      },
    },
  },
  ...
  resolve: {
    ...
    alias: {
      "@calndrbrnd/lib/server/i18n": path.resolve(__dirname, "./i18n.ts"),
      "./server/i18n": path.resolve(__dirname, "./i18n.ts"),
      "../server/i18n": path.resolve(__dirname, "./i18n.ts"),
      "@": path.resolve(__dirname, "./src"),
      "@calndrbrnd/lib": path.resolve(__dirname, "../../lib"),
      "@calndrbrnd/trpc": resolve("../../trpc"),
      "lru-cache": resolve("../../../node_modules/lru-cache/dist/cjs/index.js"),
      "@calndrbrnd/prisma/client/runtime/library": resolve("../../prisma/client/runtime/library"),
      "@calndrbrnd/prisma/client": resolve("../../prisma/client"),
