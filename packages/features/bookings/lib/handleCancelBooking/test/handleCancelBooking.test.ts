...
vi.mock("@calndrbrnd/features/bookings/lib/payment/processPaymentRefund", () => ({
...
describe("Cancel Booking", () => {
  ...
  test("Should trigger BOOKING_CANCELLED webhook and workflow", async ({ emails }) => {
    const handleCancelBooking = (await import("@calndrbrnd/features/bookings/lib/handleCancelBooking")).default;
