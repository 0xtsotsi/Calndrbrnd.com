import { acrossQueryValueCompatiblity } from "@calndrbrnd/app-store/_utils/raqb/raqbUtils";
import type { FormResponse, Fields } from "@calndrbrnd/app-store/routing-forms/types/types";
import { zodRoutes } from "@calndrbrnd/app-store/routing-forms/zod";
import dayjs from "@calndrbrnd/dayjs";
import type { BookingRepository } from "@calndrbrnd/features/bookings/repositories/BookingRepository";
import { getBusyCalendarTimes } from "@calndrbrnd/features/calendars/lib/CalendarManager";
import type { HostRepository } from "@calndrbrnd/features/host/repositories/HostRepository";
import type { PrismaOOORepository } from "@calndrbrnd/features/ooo/repositories/PrismaOOORepository";
import { mergeOverlappingRanges } from "@calndrbrnd/features/schedules/lib/date-ranges";
import type { UserRepository } from "@calndrbrnd/features/users/repositories/UserRepository";
import logger from "@calndrbrnd/lib/logger";
import { raqbQueryValueSchema } from "@calndrbrnd/lib/raqb/zod";
import { safeStringify } from "@calndrbrnd/lib/safeStringify";
import type { PrismaAttributeRepository } from "@calndrbrnd/lib/server/repository/PrismaAttributeRepository";
import type { Prisma } from "@calndrbrnd/prisma/client";
import type { User, Booking, SelectedCalendar } from "@calndrbrnd/prisma/client";
import type { AttributeType } from "@calndrbrnd/prisma/enums";
import { RRTimestampBasis, RRResetInterval } from "@calndrbrnd/prisma/enums";
import type { EventBusyDate } from "@calndrbrnd/types/Calendar";
