import { getLocationValueForDB, OrganizerDefaultConferencingAppType } from "@calndrbrnd/app-store/locations";
import { CalVideoLocationType, type LocationObject } from "@calndrbrnd/app-store/locations";
