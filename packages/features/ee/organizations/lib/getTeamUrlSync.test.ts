...
import * as getBookerBaseUrlSyncExport from "@calndrbrnd/features/ee/organizations/lib/getBookerBaseUrlSync";

import { getTeamUrlSync } from "./getTeamUrlSync";

vi.mock("@calndrbrnd/features/ee/organizations/lib/getBookerBaseUrlSync", async () => {
  return {
