...
import type { BookerLayout } from "@calndrbrnd/features/bookings/Booker/types";
import { useEmbedBookerUrl } from "@calndrbrnd/features/bookings/hooks/useBookerUrl";
...
// yarn add @calndrbrnd/embed-react

/* If you are using npm */
// npm install @calndrbrnd/embed-react
  ${getEmbedTypeSpecificString({
...
/* If you are using yarn */
// yarn add @calndrbrnd/atoms

/* If you are using npm */
// npm install @calndrbrnd/atoms
${getEmbedTypeSpecificString({
...
function useGetEmbedSnippetString(namespace: string | null) {
  const bookerUrl = useEmbedBookerUrl();
  // TODO: Import this string from @calndrbrnd/embed-snippet
