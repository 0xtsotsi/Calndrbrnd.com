import { WEBSITE_URL, IS_SELF_HOSTED, WEBAPP_URL } from "@calndrbrnd/lib/constants";
...
export const Codes = {
  react: {
    inline: ({
      ...
      return code`
import Cal, { getCalApi } from "@calndrbrnd/embed-react";
...
export default function MyApp() {
  ...
  />;
    ...
    "floating-popup": ({
      ...
      return code`
import { getCalApi } from "@calndrbrnd/embed-react";
import { useEffect } from "react";
export default function MyApp() {
  useEffect(() => {
    (async function () {
...
export default function MyApp() {
  ...
  "react-atom": {
    inline: ({
      ...
      return code`
import { BookerEmbed } from "@calndrbrnd/atoms";
