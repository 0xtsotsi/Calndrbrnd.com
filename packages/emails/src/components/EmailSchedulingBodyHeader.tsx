  ...
  switch (headerType) {
    case "checkCircle":
      return IS_PRODUCTION
        ...
        : "https://app.calndrbrnd.com/emails/checkCircle@2x.png";
    case "xCircle":
      return IS_PRODUCTION
        ? `${BASE_URL}/emails/xCircle@2x.png`
        : "https://app.calndrbrnd.com/emails/xCircle@2x.png";
    case "calendarCircle":
      return IS_PRODUCTION
        ? `${BASE_URL}/emails/calendarCircle@2x.png`
        : "https://app.calndrbrnd.com/emails/calendarCircle@2x.png";
    case "teamCircle":
      return IS_PRODUCTION
        ? `${BASE_URL}/emails/teamCircle@2x.png`
        : "https://app.calndrbrnd.com/emails/teamCircle@2x.png";
  }
};
