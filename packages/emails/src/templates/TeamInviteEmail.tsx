...
import { APP_NAME, WEBAPP_URL, IS_PRODUCTION } from "@calndrbrnd/lib/constants";
      ...
      <div style={{ borderTop: "1px solid #E1E1E1", marginTop: "32px", paddingTop: "32px" }}>
        <p style={{ fontWeight: 400, margin: 0 }}>
          <>
            ...
            <a href="mailto:support@calndrbrnd.com" style={{ color: "#3E3E3E" }} target="_blank" rel="noreferrer">
